...
def is_known():
    ...
    data_to_save.to_csv("day31/data/words_to_learn.csv", index=False)
    next_card()
...
card_title = canvas.create_text(400, 150, text="", font=("Ubuntu", 40, "italic"))
card_word = canvas.create_text(400, 263, text="", font=("Ubuntu", 60, "bold"))
canvas.config(bg=BACKGROUND_COLOR, highlightthickness=0)
canvas.grid(row=0, column=0, columnspan=2)

x_button = tk.PhotoImage(file="day31/images/wrong.png")
unknown_button = tk.Button(image=x_button, highlightthickness=0, command=next_card)
